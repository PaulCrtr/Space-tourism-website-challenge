...
![Design preview for the Space tourism website coding challenge](src/assets/starter/preview.jpg)
...
We strongly recommend overwriting this `README.md` with a custom one. We've provided a template inside the [`README-template.md`](src/assets/starter/README-template.md) file in this starter code.
